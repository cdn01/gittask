...
<script type='text/javascript'> 
	...
	if(nextpage > 10){
		setTimeout("location.href='getreply3.php?page=1'",20000);
	}
	else if(len==undefined||len<1){
		setTimeout("location.href='getreply3.php?page=<?php echo $page;?>'",10000);
	}
	else
	setTimeout("location.href='getreply3.php?page=<?php echo $page+1;?>'",10000);
</script>